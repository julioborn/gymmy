                ...
                {alumnoSeleccionado && (
                    <div className="relative max-w-2xl mx-auto bg-white shadow-xl rounded-xl p-6 border border-gray-200">
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            <button onClick={() => router.push(`/alumnos/${alumnoSeleccionado._id}/historial`)} className="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition">
                                Historial
                            </button>
                            <button onClick={() => marcarPagoMes(alumnoSeleccionado._id)} className="bg-green-700 text-white px-4 py-2 rounded-md hover:bg-green-600 transition">
                            ...
                            <button onClick={() => iniciarPlan(alumnoSeleccionado._id)} className="bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-500 transition">
                                {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">

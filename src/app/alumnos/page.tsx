    ...
    return (
        <div className="max-w-7xl mx-auto pt-4 pb-12 px-4 lg:px-8">
            ...
            <div className={`${card} p-4 space-y-4`}>
                ...
                {/* Columna derecha — panel detalle (solo desktop) */}
                <div className="hidden lg:block lg:sticky lg:top-4">
                    {alumnoSeleccionado ? (
                        renderDetalle(alumnoSeleccionado)
                    ) : (
                        <div className="bg-white border border-black/[0.07] rounded-2xl shadow-sm flex flex-col items-center justify-center py-16 px-6 text-center">
                            ...
                            <p className="text-sm font-semibold text-slate-400">Seleccioná un alumno</p>
                            <p className="text-xs text-slate-300 mt-1">para ver sus detalles aquí</p>
                        </div>
                    )}
                </div>

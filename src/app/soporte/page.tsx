    ...
    return (
        <main className="min-h-screen bg-white px-6 py-12">
            <div className="max-w-2xl mx-auto text-slate-700">
                ...
                <p className="text-sm text-slate-500 mb-8">Centro de ayuda de Gymmy</p>

                <section className="mb-8">
                    <h2 className="text-lg font-semibold text-slate-900 mb-3">¿Necesitás ayuda?</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-lg font-semibold text-slate-900 mb-3">Preguntas frecuentes</h2>
                ...
                <section>
                    <h2 className="text-lg font-semibold text-slate-900 mb-3">Política de privacidad</h2>

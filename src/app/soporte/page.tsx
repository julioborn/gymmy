    ...
    return (
        <main className="max-w-2xl mx-auto px-6 py-12 text-slate-300">
            ...
            <section className="mb-8">
                <h2 className="text-lg font-semibold text-white mb-3">¿Necesitás ayuda?</h2>
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-2xl p-5 space-y-3">
                    <div>
                        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Correo electrónico</p>
                        <a
                    ...
                    <div>
                        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Horario de atención</p>
            ...
            <section className="mb-8">
                <h2 className="text-lg font-semibold text-white mb-3">Preguntas frecuentes</h2>
                <div className="space-y-4">
                    <div>
                        <p className="text-sm font-semibold text-white">¿Cómo registro un alumno?</p>
                        <p className="text-sm text-slate-400 mt-1">
                            Desde el menú principal, seleccioná &ldquo;Registrar Alumno&rdquo; y completá el formulario con los datos del alumno.
                        </p>
                    </div>
                    <div>
                        <p className="text-sm font-semibold text-white">¿Cómo registro una asistencia?</p>
                        <p className="text-sm text-slate-400 mt-1">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-white">¿Cómo solicito la eliminación de mi cuenta?</p>
                        <p className="text-sm text-slate-400 mt-1">
                            ...
                            <a href="mailto:gymmy.app.ar@gmail.com" className="text-emerald-400 hover:underline font-semibold">
                                gymmy.app.ar@gmail.com
                            </a>.
                        </p>
                    </div>
                    <div>
                        <p className="text-sm font-semibold text-white">¿Cómo cambio el precio de las cuotas?</p>
                        <p className="text-sm text-slate-400 mt-1">
            ...
            <section>
                <h2 className="text-lg font-semibold text-white mb-3">Política de privacidad</h2>
                <p className="text-sm text-slate-400">
                    Podés consultar nuestra{' '}
                    <a href="/privacidad" className="text-emerald-400 hover:underline font-semibold">

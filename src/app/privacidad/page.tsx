...
export default function PrivacidadPage() {
    return (
        <main className="max-w-2xl mx-auto px-6 py-12 text-slate-600">
            ...
            <section className="mb-6">
                ...
                <p className="text-sm">
                    Podés solicitar la eliminación de tu cuenta y datos personales contactándote con el administrador de tu gimnasio o escribiéndonos a <strong className="text-slate-900">julio@estudioborn.com.ar</strong>.
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-lg font-semibold text-slate-800 mb-2">7. Conservación de datos</h2>
                <p className="text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-lg font-semibold text-slate-800 mb-2">8. Contacto</h2>
                <p className="text-sm">
                    Para consultas sobre privacidad escribinos a <strong className="text-slate-900">julio@estudioborn.com.ar</strong>.
                </p>
            </section>
        </main>
    );
